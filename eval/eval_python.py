...
if not os.path.exists(data_path):
    ...
    urllib.request.urlretrieve(
        'https://raw.githubusercontent.com/karpathy/makemore/988aa59/names.txt', data_path)
...
print(f"\nTraining time: {train_elapsed:.2f}s ({train_elapsed/NUM_STEPS*1000:.1f}ms/step)")
...
print(f"\nInference time: {infer_elapsed:.2f}s ({infer_elapsed/NUM_SAMPLES*1000:.1f}ms/sample)")

# --- Save results ---
results = {
    "implementation": "python_original",
    "num_steps": NUM_STEPS,
...
print(f"\nResults saved to results_python.json")
